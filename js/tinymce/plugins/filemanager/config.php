...
//var_dump($dir);
//die();
$base_url=$dir; //url base of site if you want only relative url leave empty
$upload_dir = $dir.'/files/campaign/'; // path from base_url to upload base dir
$current_path = $dir.'files/campaign'; // relative path from filemanager folder to upload files folder
