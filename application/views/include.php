...
@import "<?php echo base_url();?>css/all.css";
@import "<?php echo base_url();?>css/fg.menu.css";
@import "<?php echo base_url();?>css/ui-lightness/jquery.ui.all.css";
@import "<?php echo base_url();?>css/jquery-ui.css";
@import "<?php echo base_url();?>css/jquery.autocomplete.css";
@import "<?php echo base_url();?>css/jquery.multiselect.filter.css";
@import "<?php echo base_url();?>css/jquery.multiselect.css";
@import "<?php echo base_url();?>css/prettify.css";
@import "<?php echo base_url();?>css/jquery-ui-timepicker-addon.css";
@import "<?php echo base_url();?>css/data_table.css";
</style>
<link type="text/css" href="<?php echo base_url();?>css/theme/ui.all.css" media="screen" rel="stylesheet" /> 
...
<script type="text/javascript"  src="<?php echo base_url();?>js/ui/jquery.ui.effect.js"></script>
...
<script type="text/javascript"  src="<?php echo base_url();?>js/ui/jquery-ui-sliderAccess.js"></script>
<script type="text/javascript"  src="<?php echo base_url();?>js/ui/jquery-ui-sliderAccess.js"></script>
